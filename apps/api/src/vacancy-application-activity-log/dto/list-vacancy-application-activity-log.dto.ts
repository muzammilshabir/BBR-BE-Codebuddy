...
export class ListVacancyApplicationActivityLogDto extends ListPropsDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'VacancyApplication ID for filtering activities',
...
export const listVacancyApplicationActivityLogSchema = PaginationSchema.append({
  search: Joi.string().optional(),
  startDate: Joi.date().iso().optional(),
  vacancyApplicationId: Joi.string().custom(joiObjectIdValidator('vacancyApplicationId')).optional(),
  endDate: Joi.date()
    .iso()
    .optional()
    .when('startDate', {
