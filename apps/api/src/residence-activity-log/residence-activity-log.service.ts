...
import { CreateResidenceActivityLogDto } from './dto/create-residence-activity-log.dto';
import { ListResidenceActivityLogDto } from './dto/list-residence-activity-log.dto';
import { PaginationService } from '@bbr/api-core/modules/pagination/pagination.service';

@Injectable()
export class ResidenceActivityLogService {
  constructor(private readonly residenceActivityLogRepository: ResidenceActivityLogRepository) {}

  async create(createDto: CreateResidenceActivityLogDto, userId: string) {
    const activityLog = {
      ...createDto,
  ...
  async list(listDto: ListResidenceActivityLogDto) {
  ...
  private async generateExcel(activityLogs: any[]): Promise<Buffer> {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Residence Activity Logs');
