...
export class ListVacancyActivityLogDto extends ListPropsDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'Vacancy ID for filtering activities',
...
export const listVacancyActivityLogSchema = PaginationSchema.append({
