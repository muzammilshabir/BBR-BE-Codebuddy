...
@Module({
  ...
  providers: [
    ResidenceService as any,
    ResidenceSeederService as any,
    ResidenceRepository as any,
    ResidenceSeeder as any,
    ResidencesFixture as any,
    CityRepository as any,
    StateRepository as any,
    ResidenceDraftRepository as any,
    ResidenceTypeRepository as any,
    BrandRepository as any,
    UserRepository as any,
    ResidenceFeatureRepository as any,
    AmenityRepository as any,
    LifeStyleRepository as any,
    UnitRepository as any,
    UnitDraftRepository as any,
    RankingRequestRepository as any,
    PropertyTypeRepository as any,
    RankingCategoryRepository as any,
    GeographicalAreasRepository as any,
    BrandCategoryRepository as any,
    UploadRepository as any,
    RankingRequestDraftRepository as any,
    RankingCategoryDraftRepository as any,
    BrandDraftRepository as any,
    ResidenceActivityLogRepository as any,
    DevResidenceActivityLogRepository as any,
    DeveloperProfileActivityLogRepository as any,
    BrandActivityLogRepository as any,
  ],
  exports: [
    ResidenceSeeder,
    ResidencesFixture,
