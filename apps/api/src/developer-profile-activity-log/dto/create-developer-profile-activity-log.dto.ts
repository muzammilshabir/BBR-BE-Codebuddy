...
export class CreateDeveloperProfilesActivityLogDto {
  @ApiProperty({
    description: 'DeveloperProfile ID associated with the activity',
...
export const createDeveloperProfilesActivityLogSchema = Joi.object({
