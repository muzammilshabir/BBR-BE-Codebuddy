...
export class ListDeveloperProfilesActivityLogDto extends ListPropsDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'DeveloperProfile ID for filtering activities',
...
export const listDeveloperProfilesActivityLogSchema = PaginationSchema.append({
