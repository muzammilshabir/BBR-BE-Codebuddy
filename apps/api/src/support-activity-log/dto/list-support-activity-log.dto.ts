...
export class ListSupportActivityLogDto extends ListPropsDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'Support ID for filtering activities',
...
export const listSupportActivityLogSchema = PaginationSchema.append({
  search: Joi.string().optional(),
  startDate: Joi.date().iso().optional(),
  supportId: Joi.string().custom(joiObjectIdValidator('supportId')).optional(),
  endDate: Joi.date()
    .iso()
    .optional()
    .when('startDate', {
