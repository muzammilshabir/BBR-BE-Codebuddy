...
export class PaymentAdminController {
  ...
  @Post('/subscription/change-method/:userId')
  @ApiOperation({
  ...
  @Put('/subscription/:userId/:residenceId')
  @ApiOperation({
  ...
  @Get('/customer-portal/session/:userId')
  @ApiOperation({
  ...
  @Get('/customer/subscriptions/:userId')
  @ApiOperation({
