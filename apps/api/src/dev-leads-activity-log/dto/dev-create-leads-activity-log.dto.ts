...
export class CreateDevLeadsActivityLogDto {
  @ApiProperty({
...
export const createDevLeadsActivityLogSchema = Joi.object({
  leadId: Joi.string().custom(joiObjectIdValidator('leadId')).required(),
