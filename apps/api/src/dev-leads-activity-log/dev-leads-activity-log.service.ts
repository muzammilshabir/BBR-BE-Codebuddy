...
import { CreateDevLeadsActivityLogDto } from './dto/dev-create-leads-activity-log.dto';
import { ListDevLeadsActivityLogDto } from './dto/dev-list-leads-activity-log.dto';

@Injectable()
export class DevLeadsActivityLogService {
  constructor(private readonly leadsActivityLogRepository: DevLeadsActivityLogRepository) {}

  async create(createDto: CreateDevLeadsActivityLogDto, userId: string) {
    const activityLog = {
      ...createDto,
  ...
  async list(listDto: ListDevLeadsActivityLogDto) {
