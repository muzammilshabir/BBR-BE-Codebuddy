...
export class ListDevResidenceActivityLogDto extends ListPropsDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'Residence ID for filtering activities',
...
export const listDevResidenceActivityLogSchema = PaginationSchema.append({
