...
export class CreateDevResidenceActivityLogDto {
  @ApiProperty({
    description: 'Residence ID associated with the activity',
...
export const createDevResidenceActivityLogSchema = Joi.object({
